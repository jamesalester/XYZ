        ...
        <div className={style.brickWall}>
          <div className={style.halfbrick}>
            <div className={style.about}>
              ...
              <p>
                My passion is developing apps and websites. I am a co-founder at
                Arcitux, a London based digital agency and specialise in Swift
                and React. I would love to hear from you.
              </p>
            </div>
            {bricks}
          </div>
